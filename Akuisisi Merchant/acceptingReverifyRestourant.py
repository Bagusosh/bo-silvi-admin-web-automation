...
time.sleep(5)
driver.find_element_by_xpath(listXpath.buttonVerifikasiUlang).click()
time.sleep(5)
driver.find_element_by_id('jumlahMejaRestoran').send_keys(listIdAkuisisi.jumlahMejaRestoranKeys)
time.sleep(5)
driver.find_element_by_id('jumlahMejaRestoran').send_keys(Keys.TAB + Keys.TAB + Keys.ENTER + Keys.ESCAPE)
