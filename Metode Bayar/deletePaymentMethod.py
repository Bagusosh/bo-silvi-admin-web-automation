...
time.sleep(4)
driver.find_element_by_xpath(listXpath.buttonEdit).click()
time.sleep(2)
driver.find_element_by_xpath(listXpath.buttonHapus).click()
time.sleep(3)
driver.find_element_by_xpath(listXpath.buttonYaHapus).click()
time.sleep(3)
